...
export default function TestDriveForm({ car, testDriveInfo }) {
  ...
  useEffect(() => {
    if (bookingError) {
      toast.error(
        bookingError.error || "Failed to Book Test Drive. Please try again."
      );
    }
  }, [bookingError]);
  ...
  return (
    <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="relative mb-4 aspect-video overflow-hidden rounded-lg">
              {car.images && car.images.length > 0 ? (
                ...
                <div className="flex-center size-full bg-gray-200">
                  <Car className="size-12 bg-gray-500" />
                </div>
              )}
            </div>
      ...
      <div className="col-span-1 lg:col-span-2">
        <Card className="mb:py-5 py-4">
          <CardContent className="mb:px-5 px-4">
            <h2 className="mb-6 text-xl font-bold">Schedule Your Test Drive</h2>
                      ...
                      <Popover>
                        <PopoverTrigger asChild>
                          ...
                          >
                            ...
                            {field.value
                              ? format(field.value, "PPP") // May 28th, 2025
                              : "Pick a date"}
                          </Button>
                        </PopoverTrigger>
                        <PopoverContent>
